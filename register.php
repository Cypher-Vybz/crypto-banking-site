...
<html lang="en">
    <head>
		...
		<!-- Title -->
		<title>Bitr - Online Banking & Fintech HTML Template</title>
    </head>
    ...
    <body>
					...
					<div class="row justify-content-center align-items-center">
						<div class="col-lg-4 col-md-6">
							<ul class="header-left-content">
								...
								<li>
									<span>Mail:</span>
									<a href="/cdn-cgi/l/email-protection#177478796376746357757e63653974787a">
										<span class="__cf_email__" data-cfemail="066569687267657246646f72742865696b">[email&#160;protected]</span>
									</a>
								</li>
							</ul>
						</div>
					...
					<nav class="navbar navbar-expand-md navbar-light">
						...
						<div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
							...
							<div class="others-options">
								<ul>
									<li>
										<a href="login.html" class="default-btn login">
											Login
										</a>
									</li>
									<li>
		...
		$fstn=htmlspecialchars($_POST["fstn"] ?? '');
		$lstn=htmlspecialchars($_POST['lstn'] ?? '');
		$usrn=htmlspecialchars($_POST['usrn'] ?? '');
		$pswd=htmlspecialchars($_POST['pswd'] ?? '');
		$cpswd=htmlspecialchars($_POST['cpswd'] ?? '');
		$email=htmlspecialchars($_POST['email'] ?? '');
		$sub=null;

		$stmt = $connect->prepare("SELECT email FROM `wells_fargo` WHERE `email` = ?");
		...
		echo $sql =" INSERT INTO `wells_fargo` (first_name,last_name,user_name,password,email)
		VALUES('$fstn', '$lstn', '$usrn', '$pswd',$email)";
		...
		echo "Error: " . $sql . "<br>" . $connect->error;
					...
					<div class="row">
						...
						<div class="col-12">
							<div class="form-group">
								...
								<input class="form-control" type="text" placeholder="Firstname" name="fstn">
							</div>
						</div>
						...
						<div class="col-12">
							<div class="form-group">
								...
								<input class="form-control" type="text" placeholder="Lastname" name="lstn">
							</div>
						</div>
						...
						<div class="col-12">
							<div class="form-group">
								...
								<input class="form-control" type="text" placeholder="Username" name="usrn">
							</div>
						</div>
						...
						<div class="col-12">
							<div class="form-group">
								...
								<input class="form-control" type="password" placeholder="Username" name="pswd">
							</div>
						</div>
            ...
            <div class="col-12">
							<div class="form-group">
								...
								<input class="form-control" type="password" name="cpswd">
							</div>
						</div>
						...
						<div class="col-12">
							<p class="create">Already have an account? <a href="login.html">Login</a></p>  
						</div>
					</div>
				</form>
			</div>
						...
						<div class="single-widget">
							...
							<ul class="address-link">
								...
								<li>
									<i class="flaticon-phone-call"></i>
									<span>Mail Us:</span>
									<a href="/cdn-cgi/l/email-protection#b4dcd1d8d8dbf4d6ddc0c69ad7dbd9"><span class="__cf_email__" data-cfemail="462e232a2a2906242f32346825292b">[email&#160;protected]</span></a>
								</li>
							</ul>
						</div>
					</div>
		...
		<div class="copy-right-area bg-color-1e1d1d">
			<div class="container">
				<div class="copy-right-content">
					<p>© Bitr is Proudly Owned by <a href="https://envytheme.com/" target="_blank">EnvyTheme</a></p>
				</div>
			</div>
		</div>
		<!-- End CopyRight Area -->
